...
contract VaultStatefulFuzzTest is Test {
     ...
     */
    function testFuzz_StatefulMultiUserSequence(
        uint256 u1d1, uint256 u2d1, uint256 u3d1,
        uint256 u1d2, uint256 u2w1
    ) public {
     ...
     */
    function testFuzz_StatefulPartialRedemptions(
        uint256 deposit,
        uint256 redeem1,
        uint256 redeem2
    ) public {
    ...
    function testFuzz_StatefulConcurrentOperations(
        uint256 u1d, uint256 u2d, uint256 u3d,
        uint256 u1w, uint256 u2r, uint256 u3w
    ) public {
     ...
     */
    function testFuzz_StatefulStressOperations(
        uint8 numOperations,
        uint256 baseAmount,
        uint8 operationType
    ) public {
     ...
     * through operations
     */
    function testFuzz_StatefulAssetInvariant(
